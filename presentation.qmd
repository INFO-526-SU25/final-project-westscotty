...
:::::: columns
::: {.column width="65%"}
![Description ...](images/by_year_month.png)
:::

:::: {.column width="35%"}
::: {style="font-size: 0.75em; line-height: 1.25"}
**Note:** Time plot of `duration_magnitude_md` and `depth_km`. This shows that the average depth and duration magnitude measured have stabilized.
:::
::::
::::::
...
:::::: columns
::: {.column width="65%"}
![Description...](images/depth_error_binned_mount.png)
:::

:::: {.column width="35%"}
::: {style="font-size: 0.75em; line-height: 1.25"}
**Note:** Another view of the Depth of the seismic events over time.
:::
::::
::::::
...
:::::: columns
::: {.column width="65%"}
![Description ...](images/duration_magnitude_error_binned.png)
:::
